...
public class YeShenActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yeshen);

        macEdit=(EditText) findViewById(R.id.yeshen_mac_show);
        macEdit.setText(app.getCurMacAddress());
        findViewById(R.id.yeshen_btn_mac).setOnClickListener(this);

        imeiEdit=(EditText) findViewById(R.id.yeshen_imei_show);
        imeiEdit.setText(getTMInfo(TM_IMEI));
        findViewById(R.id.yeshen_btn_imei).setOnClickListener(this);

        phoneEdit=(EditText) findViewById(R.id.yeshen_linenum_show);
        phoneEdit.setText(getTMInfo(TM_PHONE));
        findViewById(R.id.yeshen_btn_linenum).setOnClickListener(this);

        imsiEdit=(EditText) findViewById(R.id.yeshen_imsi_show);
        imsiEdit.setText(getTMInfo(TM_IMSI));
        findViewById(R.id.yeshen_btn_imsi).setOnClickListener(this);

        simserialEdit=(EditText) findViewById(R.id.yeshen_simserial_show);
        simserialEdit.setText(getTMInfo(TM_SIMSERIAL));
        findViewById(R.id.yeshen_btn_simserial).setOnClickListener(this);

        lunchTimeEdit=(EditText) findViewById(R.id.yeshen_brush_time);
        bathBtn=(Button) findViewById(R.id.yeshen_btn_brush_sber_batch);
        bathBtn.setOnClickListener(this);

        findViewById(R.id.yeshen_btn_changeui_system).setOnClickListener(this);
        findViewById(R.id.yeshen_btn_changeui_app).setOnClickListener(this);

        TextView modelShowView= (TextView) findViewById(R.id.yeshen_model_show);
        modelShowView.setText(""+ Build.BOARD+" "+android.os.Build.MODEL);
    ...
    private void changeWiFiInfo(){
        ...
        String result=RootCmd.execRootCmd("/system/bin/nox-prop");
        Utils.e("=================>"+randomMac,"---->"+result);
        RootCmd.execRootCmd("setprop ro.nox.host.mac '" + randomMac + "'");
    ...
    private void changeTMinfo(int type){
        ...
        switch (type) {
            case TM_IMEI:
                ...
                RootCmd.execRootCmd("setprop ro.nox.imei '"+radomeInfo+"'");
                break;

            case TM_PHONE:
                radomeInfo=DeviceUtils.getRoandomPhoneNum();
                RootCmd.execRootCmd("setprop nox.linenum '"+radomeInfo+"'");
                break;

            case TM_IMSI:
                radomeInfo=DeviceUtils.getRoandomSMSI();
                RootCmd.execRootCmd("setprop nox.imsi '"+radomeInfo+"'");
                break;

            case TM_SIMSERIAL:
                radomeInfo=DeviceUtils.getRoandomSimNum();
                RootCmd.execRootCmd("setprop nox.simserial '"+radomeInfo+"'");
                break;
            default:
                break;
        }
    ...
    public void onClick(View v) {
        ...
        MyAnimation.clickAnim(v, new MyAnimation.MyAnimListner() {
            ...
            public void animEnd(View v) {
                switch (v.getId()) {
                    case R.id.yeshen_btn_mac:
                        changeWiFiInfo();
                        break;

                    case R.id.yeshen_btn_imei:
                        changeTMinfo(TM_IMEI);
                        break;

                    case R.id.yeshen_btn_linenum:
                        changeTMinfo(TM_PHONE);
                        break;

                    case R.id.yeshen_btn_imsi:
                        changeTMinfo(TM_IMSI);
                        break;

                    case R.id.yeshen_btn_simserial:
                        changeTMinfo(TM_SIMSERIAL);
                        break;

                    case R.id.yeshen_btn_brush_sber_batch:
                        if (mSession.getBathing()) {
                    ...
                    case R.id.yeshen_btn_changeui_system:
                    ...
                    case R.id.yeshen_btn_changeui_app: {
                        ...
                        //主要是设置点击通知时显示内容的类
                        PendingIntent m_PendingIntent = PendingIntent.getActivity(YeShenActivity.this, 0, m_Intent, 0);
                        //构造Notification对象
